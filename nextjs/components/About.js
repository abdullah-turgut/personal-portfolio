  ...
  return (
    <div className="container mx-auto h-full flex flex-col justify-end py-12 px-8 text-center lg:px-20">
      <div className="mx-auto flex flex-col mt-auto gap-y-3 justify-center items-center lg:flex-row lg:gap-x-10">
        ...
        <div>
          <p className="text-white lg:text-left  mr-auto">about</p>
          <p className="mt-auto lg:order-1 lg:text-left lg:leading-10">
            ...
            the first time in the company I worked. As a hobby, I started to
            learn JavaScript. My interest in software development got deeper. I
            wanted to change my career in this field. In November 2022, I got
            accepted to intensive fullstack web development program. My goal is
            to have a fresh career in software field and improve myself.
          </p>
        </div>
      </div>
